...
public class ColorSetter {
	...
	public static Message updateColor() {
		String content = "";
		Message message = MessageInfo.message;
		String rawMessageContent = message.getContentRaw();
		String filterCommandOut = rawMessageContent.replaceAll(commands.CommandList.cmdSetEmbedColor.getCommand(), "")
				.trim();
	...
	public static Command updateCommand(String cmdSign, String adminCmdSign)
		...
		return new CommandBuilder("setembedcolor", cmdSign, "", CommandType.COLOR,
				"allows you to set the color of your embed sidebar.", "thisCommand (Hexdecimal Color Code Here)")
						.addFirstExample("thisCommand #ffff00").addSecondExample("thisCommand #ffffff")
						.addMethod(ColorSetter.class.getMethod("updateColor")).build();
	}
